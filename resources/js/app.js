...
Vue.component('usurio-component', require('./components/UsurioComponent.vue').default);
...
Vue.component('citasdetalle-component', require('./components/CitasDetalleComponent.vue').default);
